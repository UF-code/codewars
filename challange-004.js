...
// Even though it is the last bus stop, the bus is not empty and some
...
const number = (busStops) => {
  let personCountInStops = []

  busStops.map((stop) => personCountInStops.push(stop[0] - stop[1]))

  return personCountInStops.reduce((a, b) => a + b, 0)
}
